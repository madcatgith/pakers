 ...
 * В»a|b|cВ« is a good depth where В»a|b|c|d|e|f|g|h|i|j|kВ« isn't. Try to join correlating
 * cache groups: if your cache groups look somewhat like В»a|b|$page|$items|$whateverВ«
 * consider using В»a|b|c|$page-$items-$whateverВ« instead.
 *
 * @package Smarty
 * @subpackage Cacher
 * @author Rodney Rehm
