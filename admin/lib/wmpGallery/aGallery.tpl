...
<div class="demo ui-widget ui-helper-clearfix">
    ...
    <div style="clear: left; padding: 8px; position: relative;">
        ...
        <div class="form-group col-md-8">
            <button id="loadImage" type="button" class="btn fz13 btn-sm">Загрузить с ПК</button>
            <button id="cancelLoadImage" type="button" class="btn fz13 btn-sm" onclick="cancelQueue(upload);">Отмена загрузки</button>
            <button id="addImage" type="button" class="btn fz13 btn-sm">Добавить из файлов</button>
            <button id="addYoutube" type="button" class="btn fz13 btn-sm">Добавить видео (Youtube)</button>
        </div>
        <div class="form-group col-md-8">
            <button id="savePlace" type="button" class="btn btn-primary fz13 btn-sm">Сохранить позиции</button>
            <button id="closeWin" type="button" class="btn btn-primary fz13 btn-sm">Закрыть</button>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    {
        $('#photogalary1, #galleryEditHolder').hide();
    });
