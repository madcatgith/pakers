...
echo admin_func_right_table_data('<select style="width: 305px;" name="category_id"><option value="3"' . ($parent_id == 3 ? ' selcted="selected"' : '') . '>Каталог</option>' . Helpers::walkRecursive($categories, 3, 1, $category_id) . '</select>', '', '2tr');
