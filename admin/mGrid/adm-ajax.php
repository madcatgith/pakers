...
$bases = $_POST['bases'];
if (!isset($bases)) {
	echo 'РЅРµ РІС‹Р±СЂР°РЅР° РЅРё РѕРґРЅР° Р±Р°Р·Р° РґР°РЅРЅС‹С… РґР»СЏ СЂРµРґР°РєС‚РёСЂРѕРІР°РЅРёСЏ!';
	exit;
}

include("../../../config.php");

//РџРѕРґРєР»СЋС‡РµРЅРёРµ РєРѕРЅС„РёРіСѓСЂР°С†РёРѕРЅРЅРѕРіРѕ С„Р°Р№Р»Р°
...
switch($action){
	case "check_cnc":
		...
		if (array_key_exists($_POST['field'], $from["nonlang_field"])){
			// Р»РµР¶РёС‚ РІ Р±РµР·СЏР·С‹РєРѕРІРѕР№
...
/*
                ...
                <div style="height: 82px; margin: 1px 1px 0px 0px; padding-left: 10px; float: left; width: 479px; position: relative; overflow: hidden;">
                    <div style="float: left; ">
                        <br><div style="float:left; width:30px">РЈРєСЂ:</div> <input type="text" style="width: 300px; color: rgb(117, 118, 120); padding: 2px 0pt 1px 10px; border: 1px solid rgb(213, 214, 210); font: 11px Tahoma;" value="'.$title_array[0].'" id="gallery_'.$id.'_l3">
                        <br><div style="float:left; width:30px">Р СѓСЃ:</div> <input type="text" style="width: 300px; color: rgb(117, 118, 120); padding: 2px 0pt 1px 10px; border: 1px solid rgb(213, 214, 210); font: 11px Tahoma;" value="'.$title_array[1].'" id="gallery_'.$id.'_l2">
                        ...
                        <input type="button" value="РёР·РјРµРЅРёС‚СЊ" style="color: rgb(117, 118, 120); border: 1px solid rgb(213, 214, 210); font: 12px Tahoma; width: 90px; margin: 0px 0px 0px 2px;" class="gallery_'.$id.'"></div></div>
                       ...
                       <input type="button" value="СѓРґР°Р»РёС‚СЊ" style="color: rgb(117, 118, 120); border: 1px solid rgb(213, 214, 210); font: 12px Tahoma; width: 90px; float: left; margin: 0px 0px 0px 2px;" class="gallery_'.$id.'">
