...
$from         = array("table" => "event_slider", "as" => "etm", "lang" => "1", "style" => "width:100%",
                        "nonlang_field" => array(
                            "id"      => array(
                                                        "title"   => "id",
                                                        "style"   => "width: 40px;",
                        ...
                        "multylang_field" => array(
                            "title"      => array(
                                                    "title"   => "Название",
                                                    "colType" => "text"
                                                    ,"description" => "Всегда выводимое название. 'Lady Gaga 4ever'"
                                                ),
                            ...
                            "announcement"      => array(
                                                    ...
                                                    "colType" => "textarea"
                                                    ,"description" => "Текст, что под названием"
                                                ),                                                
                            ...
                            "image"      => array(
                                                    ...
                                                    ,"tablestyle"   => "width: 50px; "                                                    
                                                    ,"colType" => "image"
                                                    ,"description" => "размера 570*286"
                                                ),                                                
                                               
                        ),
                        "row_seq"            => array("id", "city_id", 'category_id', "date_from", "date_to", "announcement", "title", "image_small", "image", "place")
                );
...
$from         = array("table" => "event_slider", "as" => "es", "lang" => "1",
						"normal_field" => array(
							"id"      => array(
														"title"   => "id",
														"style"   => "width: 40px;",
